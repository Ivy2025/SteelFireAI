...
def main() -> None:
    ...
    target_configs = [
        {
            "name": "fy",  # 修改：改为基础名称
            "true_col": "fy_true",  # 修改：直接指定真实值列名
            "pred_col": "fy_pred",  # 修改：直接指定预测值列名
        ...
        {
            "name": "fu",  # 修改：改为基础名称
            "true_col": "fu_true",  # 修改：直接指定真实值列名
            "pred_col": "fu_pred",  # 修改：直接指定预测值列名
        ...
        {
            "name": "E",  # 修改：改为基础名称
            "true_col": "E_true",  # 修改：直接指定真实值列名
            "pred_col": "E_pred",  # 修改：直接指定预测值列名
