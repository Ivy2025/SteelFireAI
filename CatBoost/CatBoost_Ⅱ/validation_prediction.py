...
from data_loader import FEATURE_COLUMNS, NUMERIC_FEATURE_COLUMNS, TARGET_COLUMNS
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="plan3",
        help="Plan name in model filenames, e.g. plan3 or planA.",
    )
    parser.add_argument(
        "--output",
        type=str,
...
def main() -> None:
    """CLI entry point for validation prediction generation."""
